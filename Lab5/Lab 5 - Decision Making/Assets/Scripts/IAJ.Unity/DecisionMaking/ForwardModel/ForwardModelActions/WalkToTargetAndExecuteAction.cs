...
namespace Assets.Scripts.IAJ.Unity.DecisionMaking.ForwardModel.ForwardModelActions
{
    public abstract class WalkToTargetAndExecuteAction : Action
    {
        ...
        protected WalkToTargetAndExecuteAction(string actionName, AutonomousCharacter character) : base(actionName + "(" + "SELF" + ")")
        {
            this.Character = character;
            this.Target = null;
        }
        ...
        protected virtual float GetDuration(Vector3 currentPosition)
        {
        ...
        public override float GetHValue(WorldModel worldModel)
        {
            ...
            var distance = (this.Target.transform.position - position).magnitude;
