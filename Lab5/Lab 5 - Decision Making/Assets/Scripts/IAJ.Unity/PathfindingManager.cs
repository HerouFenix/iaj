...
public class PathfindingManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        this.pathfinding = new NodeArrayAStarPathfinding(width, height, cellSize, new SimpleUnorderedNodeList(), new ClosedDictionary(), new EuclideanDistance());
    ...
    void Update()
    {
        ...
        {
            this.finished = this.pathfinding.Search(out this.solution, true);
    ...
    public void InitializeSearch(Vector3 startingPosition, Vector3 goalPosition, string type)
    {
        TargetType = type;
        int startingX, startingY;
        this.pathfinding.grid.GetXY(startingPosition, out startingX, out startingY);
        ...
        for (int i = 0; i < textLines.GetLength(0); i++)
            for (int j = 0; j < textLines.GetLength(1); j++)
                ...
                else if (textLines[i, j] == "D")
                {
                    ...
                    drag.transform.Translate(cellSize * 0.5f, 1.0f, cellSize * 0.5f);
                ...
                else if (textLines[i, j] == "o")
                {
                   //Orcs
                    ...
                    orc.transform.Translate(cellSize * 0.5f, 1.0f, cellSize * 0.5f);
